...
export const HeroSection = async ({ lang }: { lang: Locale }) => {
  ...
  return (
    <section className="relative min-h-[98vh] flex flex-col justify-center pt-28">
      ...
      {/* Content */}
      <div className="relative z-10 flex-1 container mx-auto px-4 flex flex-col justify-center items-center text-center py-12 md:py-20">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-8xl font-display mb-0 md:mb-2">
          <span className="text-white whitespace-pre-line font-semibold">
        ...
        <p className="mb-10 max-w-md px-1 text-base  leading-5 whitespace-normal text-[#EAF0F2] tracking-wide sm:max-w-xl sm:px-0 sm:text-center md:mb-12 md:text-xl md:leading-9 md:tracking-widest md:whitespace-pre-line">
