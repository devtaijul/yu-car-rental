...
const AboutUs = async ({ lang }: { lang: Locale }) => {
    return (
        <div className="flex flex-col bg-background">
            ...
            <section className="bg-primary py-14 text-white sm:py-16 md:py-20 lg:py-20">
            ...
            <section className="bg-background py-14 text-center sm:py-16 md:py-20 lg:py-20">
                <div className="container mx-auto px-4 max-w-6xl text-center">
                    <div className="w-20 h-20 flex items-center justify-center mx-auto mb-10 bg-[#F8FAFC] rounded-full">
                        <Icons
                            name="hart_icon"
                            className="h-9 w-9 text-primary mx-auto"
                        />
                    </div>
                    <span className="flex flex-wrap items-center justify-center gap-x-1 text-center text-xs font-bold tracking-[0.12em] text-primary sm:gap-x-2 sm:tracking-[0.2em] md:text-base">
                        THE{" "}
                        <Image
                            src={"/assets/YU.png"}
                    ...
                    <p className="mx-auto mb-10 text-center text-base font-light sm:text-lg md:mb-12 md:text-xl lg:text-3xl">
                        &quot;At YU CAR RENTAL, everything revolves around ease,
                        trust and a <br className="hidden lg:block" />
                        heartfelt welcome. We make sure your car is perfectly
                        prepared, with clear instructions and personal
                        service.&quot;
                    </p>
                    <p className="mx-auto max-w-xl text-sm font-bold uppercase tracking-[0.12em] text-primary opacity-90 sm:text-base md:text-lg md:tracking-widest">
                        FROM THE MOMENT YOU ARRIVE, YOUR JOURNEY BEGINS IN STYLE
                        - RELAXED, SMOOTH AND STRESS-FREE.
                    </p>
                </div>
            </section>

            {/* Freedom CTA */}
            <section className="bg-[#F8FAFC] py-16 text-center sm:py-20 lg:py-24">
                <div className="container mx-auto px-4">
                    <span className="text-xs font-bold tracking-[0.12em] text-primary sm:text-sm sm:tracking-[0.16em] md:text-base md:tracking-[0.2em]">
