...
const AirportPickup = () => {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="bg-[#214C5A] py-16 lg:py-20">
        <div className="container mx-auto px-4">
            ...
            <div className="bg-[#142D35] text-white  p-6 shadow-xl">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="relative flex items-center gap-1 rounded-full px-2 py-1 text-xs text-[#2F6B7F]">
                  ...
                  <span className="relative text-green-500">ACTIVE</span>
                </span>
              </div>
      ...
      <section className="bg-[#F8FAFC] py-16 text-center lg:py-24">
        <div className="container mx-auto px-4">
          ...
          <div>
            <h2 className="mt-4 mb-2 text-4xl font-display font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-9xl">
              START IN
            </h2>
            <TextStroke
              strokeWidth="1px"
              className="text-4xl font-bold italic tracking-tighter sm:text-5xl md:text-6xl lg:text-9xl"
            >
              HIGH GEAR.
            </TextStroke>
          </div>
