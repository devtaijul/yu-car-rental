                ...
                <span className="text-xs tracking-[0.2em] text-muted-foreground font-medium">
                  AIRPORT PICKUP SERVICE
                            ...
                            <p className="text-dark-text text-sm max-w-sm mb-6 leading-relaxed">
                                Escape the chaos of the terminal. The redesigned
                                airport is expected to provide an experience as
                                tranquil and serene as the Caribbean sea itself.
                                No queues, no shuttle, just pure island flow
                            </p>
                            ...
                            <div className="mt-8 border-l-4 border-dark-text pl-5 uppercase sm:pl-6 lg:pl-8">
                                ...
                                <div className="mt-3 flex flex-wrap items-center gap-3 text-sm font-bold tracking-[0.2em] text-black sm:text-base">
                                    <span>
                                        KLM • TUI • DELTA • AMERICAN • Corendon
                                    </span>
                                    {/*  <Link
                    href="/help"
                    ...
                    <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-12">
                        <div className="text-primary-foreground">
                            ...
                            <p className="text-sm text-primary-foreground/70 max-w-md mb-8 leading-relaxed">
                                We operate on your schedule, not the
                                airline&apos;s. Our proprietary tracking system
                                monitors Flamingo Airport (BON) in real-time to
                                match arrivals with your exact pickup, delayed
                                or early — we are always where you need us to
                                be.
                            </p>
