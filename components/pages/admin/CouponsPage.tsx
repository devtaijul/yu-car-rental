        ...
        <div className="flex border rounded-lg overflow-hidden">
          {statusTabs.map((tab, i) => (
            <button
              ...
              className={`px-5 py-2 text-xs font-semibold tracking-wider transition-colors ${activeTab === i ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
            >
              {tab}
            </button>
          ))}
