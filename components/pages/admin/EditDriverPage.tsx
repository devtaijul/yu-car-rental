    ...
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-foreground">
          EDIT <span className="text-primary">DRIVER</span>
        </h1>
        <p className="text-muted-foreground mt-1">
          Update driver details and verification status.
        </p>
      </div>
      ...
      >
          ...
          <div className="bg-card rounded-xl border p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold">⭐ {form.rating}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Total Trips</span>
                <span className="font-bold">{form.trips}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            >
              <Save className="h-4 w-4" /> UPDATE DRIVER
            </button>
          </div>
        </div>
      </form>
