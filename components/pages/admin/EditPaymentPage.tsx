...
const mockPayment = {
  ...
  bookingRef: "YU-847291",
  amount: "1250.00",
  method: "CREDIT_CARD",
  cardLast4: "4242",
  status: "PAID",
  transactionId: "TXN-9928371",
  notes: "",
};
    ...
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-foreground">
          EDIT <span className="text-primary">PAYMENT</span>
        </h1>
        <p className="text-muted-foreground mt-1">
          Update payment status and details for {form.invoiceId}.
        </p>
      </div>
      ...
      >
          ...
          <div className="bg-card rounded-xl border p-6">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-mono font-bold">{form.invoiceId}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono">{form.bookingRef}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            >
              <Save className="h-4 w-4" /> UPDATE PAYMENT
            </button>
          </div>
        </div>
      </form>
