...
const mockReview = {
  ...
  customerEmail: "mich.brown@email.com",
  carId: "Mercedes C-Class",
  bookingRef: "YU-99281A",
  rating: 3,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Moderate and update review content.
        </p>
      </div>
      ...
      >
          ...
          <div className="bg-card rounded-xl border p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-xs">{form.customerEmail}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Car</span>
                <span className="font-semibold">{form.carId}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            >
              <Save className="h-4 w-4" /> UPDATE REVIEW
            </button>
          </div>
        </div>
      </form>
