...
const mockReviews = [
  {
    id: 1,
    name: "Michael Brown",
    email: "mich.brown@email.com",
    date: "OCT 25, 2023",
    rating: 3,
    title: "Good car, slightly delayed pickup",
    body: "The Mercedes was in perfect condition and drove beautifully. However, I had to wait about 15 minutes at t...",
  ...
  },
  {
    ...
    date: "OCT 24, 2023",
    rating: 5,
    title: "Absolutely flawless experience!",
    body: "This was my third time renting with YU Car Rental and they never disappoint. The BMW X5 was immaculately...",
    car: "BMW X5",
    plate: "YU-77124X",
    trip: "OCT 15 - OCT 23",
    status: "PUBLISHED",
  ...
  },
  {
    id: 3,
    name: "David Lee",
    email: "david.lee99@email.com",
    date: "OCT 22, 2023",
    rating: 5,
    title: "Great value for money",
    body: "The Tesla Model 3 was fantastic. Charging network was easy to use. The daily rate was very competitive...",
    car: "Tesla Model 3",
    plate: "YU-55419T",
    trip: "OCT 18 - OCT 21",
    status: "PUBLISHED",
  ...
  },
  {
    id: 4,
    name: "Emily Davis",
    email: "emily.d.88@email.com",
    date: "OCT 21, 2023",
    rating: 2,
    title: "Car wasn't cleaned properly",
    body: "When I picked up the Audi Q7, there were still crumbs in the back seat and the windshield was smudged on the...",
    car: "Audi Q7",
    plate: "YU-21094Q",
    trip: "OCT 19 - OCT 20",
    status: "PENDING",
